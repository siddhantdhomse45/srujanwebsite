        ...
        <motion.div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: 1260, margin: "0 auto", padding: "clamp(48px,8vw,96px) clamp(24px,5vw,64px)", y: contentY, opacity }}>
          <div style={{ maxWidth: 620 }}>
            ...
            <motion.p className="ch-body"
              ...
              For over 13 years, Intellectsoft has been helping technology startups, global brands, and Fortune 500 companies create impactful software solutions. Learn why they have chosen us and how we have helped them to change people's lives.
            </motion.p>
