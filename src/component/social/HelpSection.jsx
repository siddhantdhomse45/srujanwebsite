    ...
    >
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .hs-content { flex: 1; padding: clamp(28px,4vw,44px); position: relative; overflow: hidden; }
        ...
        @media (max-width: 768px) {
          .hs-inner { padding: 0 18px; }
          .hs-card { flex-direction: column; }
          .hs-img-wrap { width: 100%; height: 200px; }
        }
      `}</style>
