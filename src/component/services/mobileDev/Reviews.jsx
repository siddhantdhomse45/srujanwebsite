...
const reviews = [
  {
    ...
    full: "The Srujan Infotech team transformed our legacy banking system into a modern, scalable platform. Their proactive communication via daily standups and their ability to react quickly to our changing requirements made the entire experience seamless. We are onboard for all future versions.",
    accent: "#38bdf8",
  },
  {
    id: 2,
    ...
    flag: "🇮🇳",
    rating: 5.0,
    quote: "Srujan Infotech always finds time to explore new innovations for us and have demonstrated a real willingness to react quickly to change.",
  ...
  },
  {
    ...
    full: "Srujan Infotech fully built and tested all e-commerce features which were pushed live to production. The team was very responsive to client requests and communicated regularly via Slack, email, and weekly video meetings. The client was impressed by their professionalism and technical depth.",
    accent: "#34d399",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    full: "Srujan Infotech delivered a real-time fleet tracking and delivery management system that our ops team loves. Their use of agile sprints with bi-weekly demos kept us fully informed. The React Native app performs flawlessly on both iOS and Android with a 4.8-star store rating.",
    accent: "#c084fc",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    full: "Srujan Infotech built an AI-powered property recommendation engine with 3D virtual tours and instant loan eligibility checks. The backend handles 100,000 concurrent users without any performance degradation. Their architecture-first approach saved us from costly rewrites later.",
    accent: "#fbbf24",
  },
  {
    id: 8,
    ...
    full: "From the restaurant partner portal to the customer app and delivery executive dashboard, Srujan Infotech built all three surfaces cohesively. Real-time order tracking and dynamic pricing algorithms work flawlessly. The team's communication and transparency were top-notch throughout the project.",
    accent: "#38bdf8",
  },
  {
    id: 9,
    ...
    full: "Building a payment gateway requires precision and deep regulatory knowledge. Srujan Infotech delivered a PCI-DSS compliant system with multi-factor authentication, fraud detection ML models, and a real-time transaction dashboard. Their documentation was so thorough that our compliance team was impressed.",
    accent: "#818cf8",
  },
  {
    id: 10,
    ...
    flag: "🇮🇳",
    rating: 4.5,
    quote: "Our travel booking platform now handles 5 lakh bookings per month. Srujan Infotech's scalable architecture made this possible.",
