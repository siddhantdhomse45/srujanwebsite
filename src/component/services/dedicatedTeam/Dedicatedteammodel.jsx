      ...
      <section ref={sectionRef} className="dtm-section">
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 10 }}>
          ...
          <div ref={headRef} style={{ textAlign: "center", marginBottom: 72 }}>
            ...
            >
              Purple Techno-Vision LLP supports multiple clients in meeting their technology needs. We stick to the
          ...
          <div className="dtm-col-headers">
            ...
            {/* Purple Techno-Vision LLP label */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
          ...
          {ROWS.map((row, i) => (
            <div key={row.number}>
              <div className="dtm-row">
                ...
                {/* Right — Purple Techno-Vision LLP role */}
