                    ...
                    <div className="fixed left-1/2 -translate-x-1/2 bg-white shadow-2xl z-[200]" style={{ top: "64px", width: "min(1150px, 100vw)" }}>
                      <div className="grid grid-cols-2">
                        <div className="relative h-[280px]">
                          ...
                          <div className="absolute inset-0 bg-black/40" />
                          <div className="absolute inset-0 flex items-center px-10">
                            <h3 className="text-white text-[18px] leading-8 font-medium">Intellectsoft brings the latest technologies to your vertical with industry-specific solutions.</h3>
                          </div>
                        </div>
                        <div className="grid grid-cols-2 gap-10 p-10">
                          <div className="space-y-5">
