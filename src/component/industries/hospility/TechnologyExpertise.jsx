...
const BLUE = "#60a5fa";       // lighter blue for dark bg
...
function ContentPanel({ service }) {
  return (
    <AnimatePresence mode="wait">
      ...
      >
        {/* left: bold title */}
        <div style={{ minWidth: "clamp(180px,28%,260px)" }}>
          <h3
            style={{
              margin: 0,
        ...
        <div style={{ flex: 1, minWidth: "clamp(200px,40%,480px)", display: "flex", flexDirection: "column", gap: 14 }}>
          <p
            style={{
              margin: 0,
