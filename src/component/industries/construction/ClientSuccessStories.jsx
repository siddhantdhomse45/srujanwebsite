...
const stories = [
  {
    ...
    solution:
      "Purple Techno-Vision LLP created an enterprise portal that eliminates significant manual efforts and builds a knowledge base collecting information from across all business units, compiling data from previous findings during customer outages. This solution increases visibility and provides employees with operational and technical information and instruction manuals to effectively operate across the units.",
