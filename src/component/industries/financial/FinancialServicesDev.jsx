...
const SERVICES = [
  ...
  },
  {
    ...
    body: "Mobile stock tracking, AI-assisted trading automation, and blockchain-based smart contracts — Intellectsoft develops software solutions that cater to your business's individual needs.",
    bullets: [
      "Securities Trading",
      "Digital Brokerage",
      "Blockchain Ledgers",
