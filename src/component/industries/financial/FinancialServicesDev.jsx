...
const SERVICES = [
  ...
  },
  {
    ...
    body: "Mobile stock tracking, AI-assisted trading automation, and blockchain-based smart contracts —Purple Techno-Vision LLP develops software solutions that cater to your business's individual needs.",
    bullets: [
      "Securities Trading",
      "Digital Brokerage",
      "Blockchain Ledgers",
