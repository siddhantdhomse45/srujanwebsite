    ...
    >
      ...
      >
        ...
        <div style={{ padding: "28px 20px 32px", background: "linear-gradient(180deg,#0d1f3c 0%,#020b18 100%)", textAlign: "center", minHeight: 320 }}>
          ...
          <div style={{ fontSize: 9, color: "rgba(148,163,184,0.4)", fontFamily: "'DM Sans',sans-serif", marginBottom: 4, letterSpacing: "0.05em" }}>an Waves Techno-Vision LLP company</div>
