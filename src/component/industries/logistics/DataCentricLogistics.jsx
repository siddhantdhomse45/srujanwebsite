...
const TabletMockup = () => (
  <div style={{
    ...
    <div style={{ background:"white", borderRadius:"12px", overflow:"hidden", boxShadow:"inset 0 1px 4px rgba(0,0,0,0.1)" }}>
      {/* Top bar */}
      <div style={{ background:"linear-gradient(135deg,#1d4ed8,#4f46e5)", padding:"10px 16px", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
        <div style={{ display:"flex", alignItems:"center", gap:"8px" }}>
          <span style={{ fontSize:"12px", color:"rgba(255,255,255,0.7)", fontWeight:"600" }}>← Back</span>
          <span style={{ fontSize:"12px", color:"white", fontWeight:"800", marginLeft:"8px" }}>SE-EV</span>
        </div>
        <div style={{
          padding:"4px 12px", borderRadius:"4px",
          background:"rgba(255,255,255,0.2)", border:"1px solid rgba(255,255,255,0.3)",
          fontSize:"10px", fontWeight:"800", color:"white", letterSpacing:"0.1em",
        }}>
          SELECT
        </div>
        <span style={{ fontSize:"10px", color:"rgba(255,255,255,0.6)" }}>10:59</span>
      </div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"180px 1fr" }}>
        ...
        <div style={{ padding:"12px", borderRight:"1px solid #e2e8f0" }}>
          ...
          <div style={{ height:"70px", background:"linear-gradient(135deg,#eff6ff,#dbeafe)", borderRadius:"8px", marginBottom:"12px", display:"flex", alignItems:"center", justifyContent:"center" }}>
            <svg viewBox="0 0 60 40" fill="none" stroke="#3b82f6" strokeWidth="1.5" width="56" height="36">
          ...
          <div style={{ fontSize:"8px", color:"#64748b", marginBottom:"3px", fontWeight:"600" }}>Clamp Force Range of Machine</div>
          <div style={{ fontSize:"9px", color:"#1e40af", fontWeight:"700", marginBottom:"8px" }}>JIS, SPI</div>
          <div style={{ fontSize:"8px", color:"#64748b", marginBottom:"3px", fontWeight:"600" }}>Tie bar Clearance</div>
          <div style={{ fontSize:"9px", color:"#1e40af", fontWeight:"700", marginBottom:"8px" }}>JIS, SPI</div>
          <div style={{ fontSize:"8px", color:"#64748b", marginBottom:"3px", fontWeight:"600" }}>Overall Platen Size</div>
          <div style={{ fontSize:"9px", color:"#1e40af", fontWeight:"700", marginBottom:"8px" }}>JIS, SPI</div>
          {/* Spec table */}
          <div style={{ fontSize:"7px", color:"#94a3b8", display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:"2px" }}>
            {["55","85","110","144","200"].map((v,i) => <span key={i} style={{ background:"#f1f5f9", borderRadius:"2px", padding:"2px 3px", textAlign:"center" }}>{v}</span>)}
          </div>
          <div style={{ fontSize:"7px", color:"#64748b", marginTop:"3px" }}>US Tonnage</div>
        </div>

        {/* Right panel - options */}
        <div>
          <div style={{ background:"#1d4ed8", padding:"8px 12px", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
            <div style={{ display:"flex", alignItems:"center", gap:"4px" }}>
              ...
              <span style={{ fontSize:"10px", fontWeight:"700", color:"white", marginLeft:"6px" }}>OPTIONS</span>
            </div>
          ...
          {[
            ...
            <div key={i} style={{
              ...
              <span style={{ fontSize:"8px", color: opt.active ? "#1e40af" : "#475569", fontWeight: opt.active ? "600" : "400", lineHeight:1.3 }}>{opt.label}</span>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ position:"absolute", inset:0, pointerEvents:"none" }}>
        <div style={{ position:"absolute", top:"-80px", right:"10%", width:"500px", height:"400px", borderRadius:"50%", background:"radial-gradient(ellipse,rgba(37,99,235,0.18),transparent 70%)" }} />
        <div style={{ position:"absolute", bottom:"-60px", left:"15%", width:"440px", height:"340px", borderRadius:"50%", background:"radial-gradient(circle,rgba(99,102,241,0.13),transparent 70%)" }} />
      ...
      <div style={{ maxWidth:"1240px", margin:"0 auto", position:"relative", zIndex:1 }}>
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"72px", alignItems:"center" }}>
          ...
          <div style={{ position:"relative", display:"flex", alignItems:"center", justifyContent:"center" }}>
            ...
            <div style={{ position:"relative", zIndex:1, transform:"rotate(-2deg)" }}>
              <TabletMockup />
            </div>
            {/* Floating stats */}
            <div style={{
              ...
              <div style={{ width:32, height:32, borderRadius:"8px", background:"linear-gradient(135deg,#059669,#10b981)", display:"flex", alignItems:"center", justifyContent:"center" }}>
                <svg viewBox="0 0 20 20" fill="none" stroke="white" strokeWidth="2.5" width="14" height="14">
                  <polyline points="4 10 8 14 16 6" />
                </svg>
              </div>
              <div>
                <div style={{ fontSize:"12px", fontWeight:"800", color:"white" }}>40% Cost Reduction</div>
                <div style={{ fontSize:"10px", color:"rgba(148,163,184,0.65)" }}>via ML optimization</div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ width:28, height:28, borderRadius:"8px", background:"linear-gradient(135deg,#7c3aed,#6366f1)", display:"flex", alignItems:"center", justifyContent:"center" }}>
                <svg viewBox="0 0 20 20" fill="none" stroke="white" strokeWidth="2" width="13" height="13">
                  <path d="M10 2v8M10 14v4" strokeLinecap="round" /><circle cx="10" cy="12" r="2" />
                </svg>
              </div>
              <div>
                <div style={{ fontSize:"11px", fontWeight:"800", color:"white" }}>Live Sensor Data</div>
                <div style={{ fontSize:"9px", color:"rgba(148,163,184,0.65)" }}>2.4M data points/sec</div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            {/* Heading */}
            <h2 style={{
              fontSize:"clamp(24px,3.2vw,44px)", fontWeight:"900",
            ...
            {/* Description */}
            <p style={{ fontSize:"15px", lineHeight:"1.9", color:"rgba(148,163,184,0.88)", margin:"0 0 36px" }}>
                  ...
                  >
                    ...
                    <div style={{ flex:1 }}>
                      ...
                      <div style={{
                        ...
                        color: isHov ? "rgba(148,163,184,0.75)" : "rgba(100,116,139,0.55)",
                        transition:"color 0.3s",
                      }}>
                        {f.description}
                      </div>
