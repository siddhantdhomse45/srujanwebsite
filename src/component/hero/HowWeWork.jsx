  ...
  return (
    <section className="relative py-28 bg-slate-950 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="hidden lg:block relative">
          {/* Line */}
          <div className="absolute top-12 left-0 w-full h-1 bg-gradient-to-r from-blue-500 via-cyan-500 to-purple-500 rounded-full"></div>
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div key={step.number} className="relative">
                  {/* Circle */}
                  <div
                    className={`w-24 h-24 mx-auto rounded-full bg-gradient-to-r ${step.color}
                    flex items-center justify-center shadow-[0_0_40px_rgba(59,130,246,0.35)]
                    hover:scale-110 transition duration-500 relative z-10`}
                  >
                  ...
                  {index !== steps.length - 1 && (
                    <ArrowRight
                      size={20}
                      className="absolute top-10 -right-4 text-cyan-400"
                    />
                  )}
                </div>
              );
