...
const contactInfo = [
  ...
  },
  {
    icon: Mail,
    label: "Email",
    value: "info@purpletechnovision.in",
        ...
        <div className="main-inner">
          ...
          <div className="form-map-grid">
            ...
            <motion.div
              ...
              style={{ ...GLASS_BRIGHT, borderRadius: 24, overflow: "hidden", position: "relative" }}
            >
              {/* Form header */}
              <div style={{
              ...
              <form onSubmit={handleSubmit} style={{ padding: "24px", display: "flex", flexDirection: "column", gap: 12 }}>
                <StyledSelect name="title" value={formData.title} onChange={handleChange}>
                ...
                <StyledInput type="text" name="mobile" placeholder="Enter Mobile Number" value={formData.mobile} onChange={handleChange} />
                <StyledInput type="email" name="email" placeholder="Enter Email Address" value={formData.email} onChange={handleChange} />

                <StyledSelect name="query" value={formData.query} onChange={handleChange}>
                ...
                <StyledTextarea name="message" placeholder="Enter Message" rows={5} value={formData.message} onChange={handleChange} />
              ...
              <AnimatePresence>
                {submitted && (
                  ...
                  >
                    <CheckCircle size={60} color="#34d399" />
                    <p style={{ color: "white", fontSize: 22, fontWeight: 700, marginTop: 16 }}>
                      Thank You!
                    </p>
